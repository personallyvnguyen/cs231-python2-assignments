...
# it.  Clicking the button causes a message to be printed to the Python
# shell.
...
# the buttons or what message is printed to the Python shell.
...
# hard-coded message to the Python shell.  In general, though, this is
# one of many reasons why using classes to implement GUIs makes a lot
# more sense, because we can use methods instead of functions to
# implement our command handlers and event handlers; since these methods
# will have a "self" parameter that will provide access to any attributes
# we store in our object, they will then have access to the information
# we need.
