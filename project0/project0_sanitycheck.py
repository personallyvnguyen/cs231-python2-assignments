# project0_sanitycheck.py Hi there, My notes start at line 23. -amT
#
# ICS 32 Winter 2021
# credit: Alex Thornton, UCI
...
#
# Passing this test will earn you a minimum of 5 points out of 30 possible.
#
# Please note that Thornton's code does NOT meet all the criteria laid out in
# David Kay's Design Recipe (gold standard for Pythonistic-ness).
#
# For example comments are missing. For this assignment code comments are
# worth 5 points, the same value as passing this test, and that's just one part
